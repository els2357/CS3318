...
*/
void print( int ** table, int string2_len, int string1_len, char * first_string, char * second_string)
{
	//Print initial row
...
Parameters:
  ...
  - diagonal - value of edit distance diagonally to the upper left of the current cell (+ 1 if chars are not equal)
...
void spell_check(char * testname, char * dictname){ 
	...
	for (int i=0; i < testn; i++)
	{
		...
		else if (choice > 1 && (count-choice) > 0 && dict_table[(distindex[choice-1])] != NULL)
		{
